...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2025 at 07:24 AM
...
ALTER TABLE `mahasiswa`
  ADD PRIMARY KEY (`NPM`);
--
-- Database: `dbms11_2440506078`
--
CREATE DATABASE IF NOT EXISTS `dbms11_2440506078` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbms11_2440506078`;
...
('09876', 'Susi Susanti', 'Bekasi', '2003-09-20', 'P', '08912345690'),
('12345', 'Galang Ahmad Ghifari', 'Banjarnegara', '2005-08-06', 'L', '085951698604'),
('54321', 'Masbowo', 'Jakarta', '1990-09-23', 'L', '08956719372'),
('67890', 'Jumadi', 'Purbalingga', '2009-08-12', 'L', '08912345678');
...
INSERT INTO `buku_buku` (`Judul`, `Jenis`, `Penerbit`, `Tanggal_terbit`) VALUES
('Siksa Dunia', 'Edukasi', 'Habibi', '2023-08-06');
...
('root', '[{\"db\":\"perpustakaan\",\"table\":\"mahasiswa\"},{\"db\":\"mahasiswa\",\"table\":\"mata_kuliah\"},{\"db\":\"mahasiswa\",\"table\":\"dosen\"},{\"db\":\"mahasiswa\",\"table\":\"mahasiswa\"}]');
...
('root', '2025-03-20 06:24:02', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `siaka`
--
CREATE DATABASE IF NOT EXISTS `siaka` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `siaka`;
--
-- Database: `sipperpus`
--
CREATE DATABASE IF NOT EXISTS `sipperpus` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sipperpus`;
--
-- Database: `test`
--
...
--
CREATE DATABASE IF NOT EXISTS `tugas_modul6` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tugas_modul6`;
...
CREATE TABLE `jurusan` (
  ...
  `nama_jir` varchar(50) DEFAULT NULL,
...
INSERT INTO `jurusan` (`kode_jur`, `nama_jir`, `kode_dos`) VALUES
...
('PT1123', 'Grafika Multimedia', 3, 5, '12'),
('PT1333', 'Basis Data Terdistribusi', 3, 5, '10'),
('PT1447', 'Praktikum Basis Data', 1, 3, '11'),
('PT1777', 'Sistem Informasi', 2, 3, '99'),
